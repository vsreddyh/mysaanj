...
export default function Searchbar1({drawer,navigation}) {
    return (
        <View className="w-full h-16 flex-row items-center bg-blue-600 fixed">
            ...
            <TouchableOpacity className="h-[50%] w-[11%] m-2" onPress={() => navigation.navigate('CreatePatient')}>
                <Image source={require('../assets/Plus.png')} className="object-contain h-full w-full"/>
            </TouchableOpacity>
        </View>
    );
}